...
An ORM independent way of managing relationships between models
...
inter-database relationships.  So, writing code that manages relationships
...
Tenacity aims to address this by providing an ORM independent way of managing
