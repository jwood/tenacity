...
Tenacity is heavily based on ActiveRecord's assocations, and aims to behave in
...
* The directories that contain your model classes must be in your load path in
order for Tenacity to find them.
